...
{
    /// <inheritdoc />
    public partial class InitialIntegerIds : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BranchFK = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Visa"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TellerFK = table.Column<int>(type: "int", nullable: true),
                    AccountFK = table.Column<int>(type: "int", nullable: true),
                    TargetAccountFK = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Transactions_Accounts_AccountFK",
                        column: x => x.AccountFK,
                        principalTable: "Accounts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transactions_Accounts_TargetAccountFK",
                        column: x => x.TargetAccountFK,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_AspNetUsers_TellerFK",
                        column: x => x.TellerFK,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_AccountFK",
                table: "Transactions",
                column: "AccountFK");
